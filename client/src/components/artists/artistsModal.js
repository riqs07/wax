...
`
 ...
 const ArtistsModal = (  ) => {
    ...
    const artist = {
        ...
        likes:20,
        grade:'a',
        imageURL:'https://waxhades123.s3.us-east-2.amazonaws.com/artists/kanye_west.jpg',
        followers:10,
    }
    ...
    {followers && (
							<Stats>
								<I 	style={{ color: "black" }}
						className="fas fa-users fa-2x"></I>
								{grade}
							</Stats>
						)}
            ...
            >Follow {name}</PrimaryButton>
            <PrimaryButton
            onClick = {handleFollow}
            >Show Albums {name}</PrimaryButton>
