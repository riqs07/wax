...
select artists.id as 'artistID' ,artists.name as `artist`,albums.id,albums.name,
...
select  albums.id as 'albumID',albums.name as 'album', songs.id,songs.name as 'name',
